          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-10 max-w-7xl mx-auto">
            ...
            <div className="bg-white shadow-lg rounded-lg p-6 flex flex-col items-center space-y-4 hover:scale-105 transition-transform">
              ...
              <div className="text-center space-y-1">
                ...
                <p className="text-gray-600 text-sm mt-2">Visionary leader with 10+ years of experience.</p>
              </div>
            ...
            <div className="bg-white shadow-lg rounded-lg p-6 flex flex-col items-center space-y-4 hover:scale-105 transition-transform">
              ...
              <div className="text-center space-y-1">
                ...
                <p className="text-gray-600 text-sm mt-2">Financial expert focused on growth.</p>
              </div>
              <div className="flex gap-4 mt-4 text-gray-400">
                <FaFacebookF className="hover:text-blue-600 cursor-pointer" />
                <FaTwitter className="hover:text-blue-400 cursor-pointer" />
            ...
            <div className="bg-white shadow-lg rounded-lg p-6 flex flex-col items-center space-y-4 hover:scale-105 transition-transform">
              ...
              />
              <div className="text-center space-y-1">
                <h3 className="text-xl font-bold">Michael Green</h3>
                <p className="text-gray-500 text-sm">Product Manager</p>
                <p className="text-gray-600 text-sm mt-2">Keeps our products user-friendly and innovative.</p>
              </div>
              <div className="flex gap-4 mt-4 text-gray-400">
                <FaFacebookF className="hover:text-blue-600 cursor-pointer" />
                <FaTwitter className="hover:text-blue-400 cursor-pointer" />
            ...
            <div className="bg-white shadow-lg rounded-lg p-6 flex flex-col items-center space-y-4 hover:scale-105 transition-transform">
              ...
              <div className="text-center space-y-1">
                ...
                <p className="text-gray-600 text-sm mt-2">Spreads the word about Chef2 with creative strategies.</p>
              </div>
              <div className="flex gap-4 mt-4 text-gray-400">
                <FaFacebookF className="hover:text-blue-600 cursor-pointer" />
                <FaTwitter className="hover:text-blue-400 cursor-pointer" />
                <a href="https://www.linkedin.com/in/wesleykieu/" target="_blank" rel="noopener noreferrer">
                    <FaLinkedinIn className="hover:text-blue-700 cursor-pointer" />
                </a>
              </div>
            </div>
